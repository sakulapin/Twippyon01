...
- (void)viewDidLoad
{
    ...
    NSURL *url = [NSURL URLWithString:@"https://api.twitter.com"
                  @"/1.1/statuses/home?timeline.json"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(self.httpErrorMessage){
        ...
        cell.profileImageView.image = [UIImage imageNamed:@"blak.png"];
        cell.tweetTextlabelHeight = [selflabelHeight:attributedTweetText];
...
{
    NSString *twwetText = self.timeLineData [indexPath.row][@"text"];
    NSAttributedString *attributedTweetText = [self labelAttributedString:tweetText];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPAth:(NSIndexPath *)indexPath
    {
        ...
        detailViewController.isStr = self.timeLineData[indexPath.row][@"id_str"];
